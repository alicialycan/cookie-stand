...
var Stores = function(minCustPerHour, maxCustPerHour, avgCookieSoldPerHour, location) {
  ...
  this.avgCookiesSoldPerHour = avgCookieSoldPerHour; //parameter is grabbing what gets passed in avgCookieSoldPerHour, when we access the constructor function (create a new store aka. use it) it's going to go through these parameters for that store and access that particular data 
